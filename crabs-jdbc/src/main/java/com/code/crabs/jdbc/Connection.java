...
import com.code.crabs.common.util.RegularExpressionHelper;
...
import com.code.crabs.jdbc.Protocol.PropertyEntry;
...
public final class Connection extends ConnectionBase {
    ...
    final com.code.crabs.jdbc.lang.Statement analyzeStatement(final String SQL) throws SQLException {
        com.code.crabs.jdbc.lang.Statement statement = this.statementCache.getStatement(SQL);
        if (statement == null) {
